...
const AdminMaterial = () => {
  ...
  const fetchData = async () => {
    ...
    const data = res.data;
    if (selectedMaterial.item !== "All") {
      const filteredData = data.filter((e) => e.item === selectedMaterial.item);
    ...
    <div id="AdminMaterial">
      ...
      <div className="container">
        ...
        <div className="item-list">
          <div className="item">
            <div className="item-header image">Hình ảnh</div>
          ...
          {materials &&
            materials?.map((item, index) => {
              return item._id == editingMaterial?._id ? (
                <div className="item item-cover" key={index}>
                  ...
                  <div className="type">
                    <TextField
                      ...
                      variant="outlined"
                      value={
                        filterList.find((e) => e.item === item.item)?.name || ""
                      }
                    />
                  </div>
                  <div className="name">
