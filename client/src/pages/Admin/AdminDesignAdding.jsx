    ...
    return (
        <div className="mt-8" id="AdminDesignDetail">
            ...
            <div className="flex">
                ...
                <div className="flex gap-10 flex-wrap mt-14 ml-16">
                    ...
                    <div style={{ height: "400px" }}>
                        ...
                        <div className="flex gap-3 mb-1" style={{ alignItems: "center", justifyContent: "space-between", width: "300px" }}>
                        </div>
                        <div className="flex gap-3 mb-1" style={{ alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div className="flex justify-center mt-10">
                ...
                <button style={{ backgroundColor: "red", marginLeft: "25px" }} className="bg-blue-400 w-60 h-16 rounded-xl text-white hover:bg-yellow-500">
                    Delete
                </button>
            </div>
        </div>
