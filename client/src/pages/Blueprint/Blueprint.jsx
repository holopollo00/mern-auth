  ...
  const calculatePrice = () => {
    ...
    if(bluePrint) {
      total =
        bluePrint?.long *
          bluePrint?.wide *
          (((bluePrint?.process != 2) ? (bluePrint?.rawPart) : 0) + ((bluePrint?.process != 1) ? (bluePrint?.finishingPart) : 0)) +
          ((bluePrint) ? ((bluePrint?.materials.door.item?.price * bluePrint?.materials.door.quantity) +
             (bluePrint?.materials.floorTitle.item?.price * bluePrint?.materials.floorTitle.quantity) +
               (bluePrint?.materials.wallTitle.item?.price * bluePrint?.materials.wallTitle.quantity) +
                 (bluePrint?.materials.paintWall.item?.price * bluePrint?.materials.paintWall.quantity) +
                   (bluePrint?.materials.roof.item?.price * bluePrint?.materials.roof.quantity) +
                     (bluePrint?.materials.window.item?.price * bluePrint?.materials.window.quantity)) : 0);
    } else {
      total =
        bluePrint?.long *
          bluePrint?.wide *
                  ...
                  return (
                    ...
                    >
                      <div className="text-2xl font-semibold ml-5 mt-5">
                        <div className={`status ${item.status.id}`}><p>{item.status.name}</p></div>
                      </div>
                      ...
                      </div>.
                      {
                        (item.status.id != "Approved") ?
                          (<div className="flex justify-around pb-5">
                            ...
                            <button className="bg-blue-400 w-32 h-12 rounded-xl text-white btn-send" style={{ backgroundColor: "green" }} onClick={() => { handleSend(item) }}>
                              Send Blueprint
                            </button>
                          </div>)
                          :
              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableBody>
                    ...
                    (bluePrint?.process == 2 || bluePrint?.process == 3) ?
                      (
                        ...
                        >
                          ...
                          <TableCell align="center">{bluePrint?.finishingPart}</TableCell>
                          <TableCell align="center">
                            {bluePrint?.wide} x {bluePrint?.long}
                          </TableCell>
                          <TableCell align="center">
                  ...
                  >
                    ...
                    <TableCell align="center">{(bluePrint?.materials?.paintWall.quantity) ? (bluePrint?.materials?.paintWall.quantity) : "Discuss"}</TableCell>
                    <TableCell align="center">
                      {bluePrint?.materials.paintWall.item?.price * (bluePrint?.materials?.paintWall.quantity)}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    ...
                    <TableCell align="center">{(bluePrint?.materials?.roof.quantity) ? (bluePrint?.materials?.roof.quantity) : "Discuss"}</TableCell>
                    <TableCell align="center">
                      {bluePrint?.materials.roof.item?.price * (bluePrint?.materials?.roof.quantity)}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    ...
                    <TableCell align="center">{(bluePrint?.materials?.door.quantity) ? (bluePrint?.materials?.door.quantity) : "Discuss"}</TableCell>
                    <TableCell align="center">
                      {bluePrint?.materials.door.item?.price * (bluePrint?.materials?.door.quantity)}
                    </TableCell>
                  </TableRow>
                  <TableRow
                    sx={{
                  ...
                  >
                    ...
                    <TableCell align="center">{(bluePrint?.materials?.window.quantity) ? (bluePrint?.materials?.window.quantity) : "Discuss"}</TableCell>
                    <TableCell align="center">
                      {bluePrint?.materials.window.item?.price * (bluePrint?.materials?.window.quantity)}
                    </TableCell>
                  </TableRow>
                  <TableRow
                    sx={{
                  ...
                  >
                    ...
                    <TableCell align="center">{(bluePrint?.materials?.wallTitle.quantity) ? (bluePrint?.materials?.wallTitle.quantity) : "Discuss"}</TableCell>
                    <TableCell align="center">
                      {bluePrint?.materials.wallTitle.item?.price * (bluePrint?.materials?.wallTitle.quantity)}
                    </TableCell>
                  </TableRow>
                  ...
                  >
                    ...
                    <TableCell align="center">{(bluePrint?.materials?.floorTitle.quantity) ? (bluePrint?.materials?.floorTitle.quantity) : "Discuss"}</TableCell>
                    <TableCell align="center">
                      {bluePrint?.materials.floorTitle.item?.price * (bluePrint?.materials?.floorTitle.quantity)}
                    </TableCell>
                  </TableRow>
